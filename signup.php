...
<div class="main2">
            ...
            else if ($_GET['error'] == 'invalidnamemail') {
    ...
    ?>
            ...
            <form action="includes/signup.inc.php" method="POST">
                ...
                <div class="inputwrapper">
                    <label for="phone"  class="newline">Mobile Number</label>
                    <input type="text" name="phone" id="phone" placeholder="Enter Your Mobile Number" value ="+91 " required maxlength="14" pattern="[+][9][1] [6789][0-9]{9}">
                </div>
                ...
                <div class="inputwrapper">
                <button type="submit" class="submitotp" onclick="phoneAuth();"> Send OTP </button>
                </div>

                <div class="inputwrapper">
                    <label for="otp" class="newline"></label>
                    <input type="text" name="OTP" id="otp" placeholder="Enter Your OTP" required pattern=[0-9]{6}>
                </div>


                <div class="inputwrapper">
                <button type="submit" class="submitotp" onclick="codeVerify();"> Verify OTP </button>
                </div> 
